...
currently_learning: ["back-end development with django"]
hobbies: ["Gaming", "Coding", "Traveling", "Art"]
```
...
<!--
**memlens/memlens** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
